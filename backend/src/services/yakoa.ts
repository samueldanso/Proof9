...
export async function createTokenAuthorization(
  tokenId: string,
  authorization: YakoaAuthorization,
): Promise<any> {
  return yakoaFetch<any>(
    `/token/${encodeURIComponent(tokenId)}/authorization`,
    {
      method: "POST",
 ...
 */
export function formatYakoaTokenId(
